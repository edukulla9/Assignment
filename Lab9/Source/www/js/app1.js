    ...
    $scope.changePword = function(uname, oldpass, newpass, newpass2) {
        ...
        function StatusUpdate( name1, username ) {
            ...
            this.toString = function () {
                return this.name1 + " has changed his password for username : " + this.username + " user";
            };
            }
            
            var admin = new StatusUpdate( "User ", uname );
    ...
    $scope.removeAcc = function(uname, pword) {
        ...
        .error(function() {
            ...
            function StatusUpdate() {
                ...
                this.state = function () { return "Admin has removed username successfully : "; };
